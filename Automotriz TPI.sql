...
call altaPedido(3,2,4);
call altaPedido(2,3,4);
SELECT * FROM Auto;
select * from Auto a inner join LineaMontaje l on a.Modelo_idModelo=l.Modelo_idModelo where l.Modelo_idModelo=1;
/*
INSERT INTO AutoxEstacion (select Numero_Chasis from Auto inner join LineaMontaje on idModelo=modelo_idModelo)
*/
/*while _idModelo == (select modelo_idModelo from LineaMontaje) do
select * from Pedido Inner Join DetallePedido on idPedido=Pedido_idPedido ;
end while;*/